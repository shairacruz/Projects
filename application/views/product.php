  	...
  	<head>
		...
		$(document).ready(function(){
			...
			$("#product-table").on("click", ".btnedit", function(){
				var id = $(this).attr("data-id");
				window.location.assign("http://digidirect.dev.ph/index.php/home/editproduct/"+id);
			});
		});
		...
		<div class="container-fluid no-gutter">
			...
			<div class="col-xs-12 no-gutter nav">
		    	...
		    	<div class="col-md-2">
		    		...
		    		<button onclick="window.location.href='http://digidirect.dev.ph/index.php/home/add_product'" type="button" class="btnadd"> Add New </button>
		    	</div>
		    	<div class="col-md-6 right-indent">
		    		<div class="form-group">
                    	<input class="form-control search" maxlength="30" placeholder="Product Name" id="ProdName" name="txtProdName" type="text" autofocus>
                    	<input type="button" value="Search" id="Search" class="up addbutton">
                    </div>
		    	</div>
